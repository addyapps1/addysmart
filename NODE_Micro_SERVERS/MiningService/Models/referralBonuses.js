...
// Post hook
referralBonusSchema.post("save", async function (doc, next) {
...
referralBonusSchema.pre(/^find/, async function (next) {
...
referralBonusSchema.post(/^find/, async function (docs, next) {
...
referralBonusSchema.pre("aggregate", function (next) {
...
export default model("referralBonus", referralBonusSchema);
