...
if (process.env.NODE_ENV === "production") {
  ...
  allowedOrigins.push(`https://${process.env.KEEP_ALIVE}`);
} else {
...
// Require routers
import advideosRouter from "./Routes/advideoroutes.js";
...
// USING THE ROUTES
app.use("/api/a/v1.00/advideo", advideosRouter); // Mounting advideos route

app.use("/api/s/v1.00/advideo", advideosRouter); // Mounting advideos route
